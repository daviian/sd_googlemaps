...
call_user_func(
	function()
	{
		...
		\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::allowTableOnStandardPages('tx_sdgooglemaps_domain_model_style');

		\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::allowTableOnStandardPages('tx_sdgooglemaps_domain_model_styler');
